...
public final class AsynchronousLoanableTask {
	...
	public static final String KEY = "ClansFree:CONCURRENT";
	...
	public void join(Player player) {
		if (getTask() == null) {
			TimeUnit unit = TimeUnit.valueOf(StringLibrary.get("Clans.timer.threshold"));
			int size = StringLibrary.getInt("Clans.timer.time-span");
